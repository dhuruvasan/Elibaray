<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="Elibaray.adminbookinventory" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Width="100" Height="100" src="book_inventory/books.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col">
                         <asp:FileUpload onchange ="readURL(this)" CssClass="btn btn-block" class="form-control" 
                             ID="FileUpload1" runat="server" Font-Italic="True" BorderStyle="Groove" BorderColor="#3399FF" />
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-3">
                  ...
                  <div class="row">
                      ...
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="book_id" DataSourceID="SqlDataSource1">
                          <Columns>
                              ...
                              <asp:BoundField DataField="genre" HeaderText="GENERE" SortExpression="genre" />
                              ...
                              <asp:BoundField DataField="publish_date" HeaderText="PUBLLISHED DATE" SortExpression="publish_date" />
                              <asp:BoundField DataField="language" HeaderText="LANGUAGE" SortExpression="language" />
                              <asp:BoundField DataField="edition" HeaderText="EDITION" SortExpression="edition" />
                              <asp:BoundField DataField="book_cost" HeaderText="COST" SortExpression="book_cost" />
                              <asp:BoundField DataField="no_of_pages" HeaderText="No of Pages" SortExpression="no_of_pages" />
                              <asp:BoundField DataField="book_descripition" HeaderText="DESCRIPITION" SortExpression="book_descripition" />
                              ...
                              <asp:BoundField DataField="book_img_link" HeaderText="IMAGE LINK" SortExpression="book_img_link" />
                          </Columns>
                          </asp:GridView>
                      </div>
